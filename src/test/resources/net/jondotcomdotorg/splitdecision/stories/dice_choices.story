...
Scenario: If you kept one red and one blue and red is higher, record one RED.
Given a choice of dice
And die A is colored RED
And die B is colored BLUE
...
Scenario: If you kept one red and one blue and blue is higher, record one BLUE.
Given a choice of dice
And die A is colored RED
And die B is colored BLUE
...
Scenario: If you kept one red and one blue and they are tied, record one blue point and one RED.
Given a choice of dice
And die A is colored RED
And die B is colored BLUE
